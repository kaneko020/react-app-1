...
const Header = () => {
  return (
    <div
      className="flex sticky top-0 left-0 w-full pc:h-[100px] h-[70px] px-6 justify-between items-center text-[#333] bg-[#f6f6f6] bg-opacity-80 z-10"
    >
      <a
        href="/"
        className="flex items-center z-20 hover:scale-[1.1] hover:transition-all duration-300 ease-in-out"
      >
      ...
      <div className="flex items-center mx-2 pc:gap-7 gap-6 pc:text-[18px] text-[14px] font-medium">
        <a
          href="/"
          className="flex pc:flex-row flex-col items-center hover:scale-[1.1] hover:transition-all duration-300 ease-in-out"
        >
